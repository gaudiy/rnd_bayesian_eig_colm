...
Usage:
    ...
    python run_gpus_vllm.py --config config_27b.yaml --start 0 --end 100
"""
import os
import sys
import yaml
...
def main():
    ...
    parser.add_argument("--config", type=str, default="config_27b.yaml")
    ...
    print(f"  cat .job_pids_27b | xargs kill")
    print("=" * 60)
